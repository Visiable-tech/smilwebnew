                    ...
                    <!-- General Form Elements -->
                        <form method="POST" action="{{ url('/admin/posts') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="hidden" class="form-control" name="post_type" value="1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">    
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="content" class="form-control" cols="10" rows="15" ></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputText" class="col-form-label">Expert</label>
                                <div class="col-sm-12">
                                    <textarea name="expert" class="form-control" cols="10" rows="5" ></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6">
