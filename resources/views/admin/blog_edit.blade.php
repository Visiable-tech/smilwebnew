        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ url('/admin/blogs/' . $post->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <div class="col-sm-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    <label for="inputNumber" class="col-form-label">Main Images</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" class="form-control" name="created_date" value="{{ $post->blog_date }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
