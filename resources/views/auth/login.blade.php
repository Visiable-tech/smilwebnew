...
<html lang="en">
    ...
    <head>
        ...
        <!--<link href="{{ asset('assets/admin_assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">-->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                <div class="d-flex justify-content-center py-4">
                                    ...
                                    <img src="{{ asset('assets/admin_assets/img/admin_logo.jpg') }}" alt="" style="max-height:100px;">
